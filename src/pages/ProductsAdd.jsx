      ...
      <main>
        <div className="flex flex-row bg-grey">
          ...
          <div className="flex flex-col gap-3 w-full font-sans">
            ...
            <h1 className="text-mid-blue text-[30px] font-bold pl-[72px]">Product</h1>
            ...
            <div className="pl-14 flex flex-col gap-16">
                <div className="bg-verylight-blue w-[59rem] h-[26rem] rounded-t-lg">
                    <div className="bg-white h-[3.5rem] rounded-t-lg">
                        <p className="text-mid-blue font-bold text-[18px] pl-8 py-4">Add Product</p>
                    </div>
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="pl-10 pt-8 gap-3">
                            ...
                            <input className="textarea-field w-[456px] rounded-[8px] placeholder-padding placeholder-style" placeholder="Name goes here"></input>
                            
                            <p className="text-[13px] font-medium pb-1 pt-4">Category</p>
                            <select className="textarea-field w-[456px] rounded-[8px] placeholder-padding placeholder-style" placeholder="Name goes here">
                              <option>Food</option>
                              <option>Drink</option>
                            ...
                            <div className="bg-dark-blue w-[64px] h-[28px] rounded-[15px] mt-2 flex items-center">
                                <Link to="/product" className="text-white font-bold text-[13px] px-4">Save</Link>
                            </div>
                        </div>
                    </div>
                </div>
